...
// Tu arreglo de datos de películas
const movieData = [
  {
...
function Pelicula() {
  ...
  useEffect(() => {
    // Lógica para obtener datos de películas desde la API o cualquier fuente de datos
  }, []);
  ...
  const handleLogout = () => {
    // Lógica para cerrar sesión (simulada)
    // Por ejemplo, limpiar el token o la información de sesión
    console.log('Cerrando sesión...');
    
    // Eliminar token o información de sesión del localStorage (simulado)
    localStorage.removeItem('token'); // Aquí debes poner el nombre de tu token o la clave que uses
